...
<body onload="OnLoad()">
	...
	<cc2:NavigationTabsActionContainer ID="NavigationTabsActionContainer" runat="server" ContainerId="ViewsNavigation" />
		...
		<td><cc2:WebActionContainer ID="DiagnosticActionContainer" runat="server"
						HorizontalAlign="Left" ContainerId="Diagnostic" CssClass="HContainer" BorderWidth="0px" CellPadding="0" CellSpacing="0" Wrapped="True">
